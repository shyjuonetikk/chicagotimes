  ...
  <div class="main-content">
      ...
      <div class="suntimes-lbox col-sm-12">
        ...
        <div class="lbox-lbox-6">
          <h3 class="bl">Democrat</h3>
          <ul>
            <li>Hillary Clinton <span class="bl"> ✔ </span>
            </li>
        ...
        <div class="lbox-lbox-6">
          ...
          <ul class="lbox-ul-2">
            <li>Marco Rubio</li>
            <li>John Kasich <span class="rd"> ✔ </span>
            </li>
            <li>Donald Trump</li>
            <li>Rand Paul</li>
            <li>Mike Huckabee</li>
      ...
      <div class="suntimes-lbox col-sm-12">
        ...
        <div class="lbox-lbox-6">
          ...
          <ul>
            ...
            <li>Andrea Zopp <span class="bl"> ✔ </span></li>
      ...
      <div class="suntimes-lbox US-House col-sm-12">
        ...
        <div class="row">
          <div class="lbox-lbox-4">
            <h3>1st District</h3>
            <h4 class="bl">Democrat</h4>
            <ul>
              <li>Bobby L. Rush <span class="bl"> ✔ </span></li>
              <li>Howard B. Brookins Jr. </li>
              <li>O. Patrick Brutus</li>
            </ul>
            <h4 class="rd">Republican</h4>
            <ul>
          ...
          <h3>2nd District </h3>
            <h4 class="bl">Democrat</h4>
            <ul>
              <li>Robin Kelly<span class="bl"> ✔ </span></li>
              <li>Marcus Lewis</li>
        ...
        <div class="row">
          <div class="lbox-lbox-4">
            ...
            <h4 class="bl">Democrat</h4>
            <ul>
              <li>Luis V. Gutiérrez <span class="bl"> ✔ </span></li>
              <li>Javier Salas</li>
            </ul>
          </div>
          <div class="lbox-lbox-4">
          <h3>5th District</h3>
            ...
            <h4 class="gr">Green</h4>
            <ul>
              <li>Warren "Grizz" Grimsley<span class="gr"> ✔ </span></li>
              <li> Rob Sherman</li>
            </ul>
          </div>
          <div class="lbox-lbox-4">
            ...
            <ul>
              ...
              <li>Amanda Howland <span class="bl"> ✔ </span></li>
            </ul>
            <h4 class="rd">Republican</h4>
            <ul>
      ...
      <div class="suntimes-lbox Illinois-state-senate col-sm-12">
        ...
        <div class="row">
          ...
          <h3>2nd District </h3>
            ...
            <ul>
              ...
              <li>Theresa Mah<span class="bl"> ✔ </span></li>
              </ul>
          </div>
          <div class="lbox-lbox-4">
            <h3>3rd District</h3>
        ...
        <div class="row">
          <div class="lbox-lbox-4">
            ...
            <h4 class="bl">Democrat</h4>
            <ul>
              <li>Cynthia Soto<span class="bl"> ✔ </span></li>
          ...
          <h3>5th District</h3>
            ...
            <ul>
              ...
              <li>Juliana Stratton<span class="bl"> ✔ </span></li>
            </ul>
          </div>
          <div class="lbox-lbox-4">
            <h3>6th District</h3>
            ...
            <ul>
              ...
              <li>Genita C. Robinson<span class="bl"> ✔ </span></li>
      ...
      <div class="suntimes-lbox Cook-County col-sm-12">
        ...
        <div class="row">
          <div class="lbox-lbox-4 spc-height">
            ...
            <ul>
              <li>Donna More</li>
              <li>Kim Foxx<span class="bl"> ✔ </span></li>
              <li>Anita Alvarez</li>
            </ul>
            <h4 class="rd">Republican</h4>
            <ul>
          ...
          <h3>Circuit Court Clerk</h3>
            ...
            <ul>
              ...
              <li>Jacob Meister<span class="bl"> ✔ </span></li>
              </ul>
              <h4 class="rd">Republican</h4>
            <ul>
              <li>Diane Shapiro</li>
          ...
          <div class="lbox-lbox-4">
            ...
            <h4>1st District (<span class="rd">Republican</span>)</h4>
            <ul>
              <li>Dan Patlak</li>
            </ul>
            <h4>2nd District (<span class="bl">Democrat</span>)</h4>
            <ul>
      ...
      <div class="suntimes-lbox col-sm-12">
        ...
        <hr>
        <p>The <a href="#">Illinois Transportation Taxes and Fees Lockbox Amendment</a>, which would bar lawmakers from using transportation funds for anything other than their stated purpose.<span class="rd"><b>NO</b></span></p>
        <p>Shall the <a href="#">Office of the Cook County Recorder of Deeds be eliminated</a> and all duties and responsibilities of the Office of the Cook County Recorder of Deeds be transferred to, and assumed by, the Office of the Cook County Clerk by December 7, 2020? <span class="rd"><b>YES</b></span></p>
      </div><!-- suntimes-lbox -->
  </div>
  <!-- main-content -->
  <div class="sidebar">
