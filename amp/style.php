...
.amp-wp-title {margin: 36px 0 0 0;font-size: 28px;line-height: 1.158;font-weight: 700;color: #2e4453;border-top: 7px solid #F0F0F0;padding-top: 20px;margin-top:12px;float:left;clear:both;width:100%;}
...
.amp-cst-meta {clear: both;width: 100%;height: 52px;}
