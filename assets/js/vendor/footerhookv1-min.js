jQuery( document ).ready(function( $ ) {
  ...
  consoleParentContainerWidth >= 835 ? (widthVar46 = "835+", $("#stylesheet-dimensions").attr("href", "http://media.newjobs.com/cms/OpenTemplate/Newspaper/2016/css/main_835x165_fluid.css")) : 835 > consoleParentContainerWidth && consoleParentContainerWidth >= 640 ? (widthVar46 = "835", $("#stylesheet-dimensions").attr("href", "http://media.newjobs.com/cms/OpenTemplate/Newspaper/2016/css/main_640x360_fluid.css")) : 640 > consoleParentContainerWidth && consoleParentContainerWidth >= 475 ? (widthVar46 = "640", $("#stylesheet-dimensions").attr("href", "http://media.newjobs.com/cms/OpenTemplate/Newspaper/2016/css/main_475x520_fluid.css")) : 475 > consoleParentContainerWidth && (widthVar46 = "475-", $("#stylesheet-dimensions").attr("href", "http://media.newjobs.com/cms/OpenTemplate/Newspaper/2016/css/main_300x520_fluid.css"));
  ...
  $(window).resize(function () {
    clearTimeout(resizeTimer), resizeTimer = setTimeout(function () {
      consoleParentContainerWidth = $(consoleParentContainer).width(), console.log(consoleParentContainerWidth), consoleParentContainerWidth >= 835 ? $("#stylesheet-dimensions").attr("href", "http://media.newjobs.com/cms/OpenTemplate/Newspaper/2016/css/main_835x165_fluid.css") : 835 > consoleParentContainerWidth && consoleParentContainerWidth >= 640 ? $("#stylesheet-dimensions").attr("href", "http://media.newjobs.com/cms/OpenTemplate/Newspaper/2016/css/main_640x360_fluid.css") : 640 > consoleParentContainerWidth && consoleParentContainerWidth >= 475 ? $("#stylesheet-dimensions").attr("href", "http://media.newjobs.com/cms/OpenTemplate/Newspaper/2016/css/main_475x520_fluid.css") : 475 > consoleParentContainerWidth && $("#stylesheet-dimensions").attr("href", "http://media.newjobs.com/cms/OpenTemplate/Newspaper/2016/css/main_300x520_fluid.css")
    }, 200)
  });
  var mnstJs = {
    searchParams: {
