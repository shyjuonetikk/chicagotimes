...
?>
    <p>
        ...
        <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'cst_shia_kapos_category_title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'cst_shia_kapos_category_title' ) ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
    </p>
<?php
    }
