...
class CST_Homepage_Featured_Story_Widget extends WP_Widget {
    ...
    ?>
        <p>
            ...
            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'cst_featured_story_title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'cst_featured_story_title' ) ); ?>" type="text" value="<?php echo esc_attr( $featured_title ); ?>" />
        </p>
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'cst_featured_story_link' ) ); ?>"><?php esc_html_e( 'Story URL:', 'chicagosuntimes' ); ?></label> 
            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'cst_featured_story_link' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'cst_featured_story_link' ) ); ?>" type="text" value="<?php echo esc_attr( $featured_link ); ?>" />
        </p>
        <p>
            ...
            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'cst_featured_story_image' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'cst_featured_story_image' ) ); ?>" type="text" value="<?php echo esc_attr( $featured_image ); ?>" />
        </p>
        <p>
            <hr/>
            <div id="wp-content-media-buttons" class="wp-media-buttons"><button type="button" id="insert-media-button" class="button insert-media add_media" data-editor="content"><span class="wp-media-buttons-icon"></span> <?php esc_html_e( 'Add Media', 'chicagosuntimes' ); ?></button></div>
        </p>
    <?php
    }
