...
class CST_Newspaper_Cover_Widget extends WP_Widget {
    ...
    <p>
        ...
        <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'cst_newspaper_front_cover' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'cst_newspaper_front_cover' ) ); ?>" type="text" value="<?php echo esc_attr( $front_cover ); ?>" />
    </p>
    <p>
        ...
        <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'cst_newspaper_back_cover' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'cst_newspaper_back_cover' ) ); ?>" type="text" value="<?php echo esc_attr( $back_cover ); ?>" />
    </p>
    <p>
        <hr/>
