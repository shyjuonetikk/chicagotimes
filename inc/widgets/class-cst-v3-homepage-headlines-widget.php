...
class CST_Homepage_Headlines extends WP_Widget {
	...
	public function __construct() {
		...
		$this->cache_key_stub = 'homepage-headlines-v3-widget';
		add_action( 'wp_ajax_cst_homepage_headlines_v3_get_posts', array( $this, 'cst_homepage_headlines_get_posts' ) );
	}
	...
	public function cst_homepage_headlines_get_posts() {
		...
		if ( ! wp_verify_nonce( $_GET['nonce'], 'cst_homepage_headlines_v3' )
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'cst_homepage_headlines_v3', get_template_directory_uri() . '/assets/js/cst-homepage-headlines-v3.js', array( 'jquery-ui-sortable', 'jquery' ) );
		wp_localize_script( 'cst_homepage_headlines_v3', 'CSTCategoryHeadlinesData', array(
			'placeholder_text'	=> esc_html__( 'Search for content to feature', 'chicagosuntimes' ),
			'nonce'				=> wp_create_nonce( 'cst_homepage_headlines_v3' ),
		) );
