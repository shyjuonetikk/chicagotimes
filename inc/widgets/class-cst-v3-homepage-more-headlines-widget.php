 ...
 *
 */
class CST_Homepage_More_Headlines extends WP_Widget {
	...
	public function __construct() {
		...
		$this->cache_key_stub = 'homepage-more-headlines-v3-widget';
		add_action( 'wp_ajax_cst_homepage_more_headlines_v3_get_posts', array( $this, 'cst_homepage_more_headlines_get_posts' ) );
	}
	...
	public function cst_homepage_more_headlines_get_posts() {
		...
		if ( ! wp_verify_nonce( $_GET['nonce'], 'cst_homepage_more_headlines_v3' )
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'cst_homepage_more_headlines_v3', get_template_directory_uri() . '/assets/js/cst-homepage-more-headlines.js', array( 'jquery' ) );
		wp_localize_script( 'cst_homepage_more_headlines_v3', 'CSTMoreHeadlinesData', array(
			'placeholder_text' => esc_html__( 'Search for content to feature', 'chicagosuntimes' ),
			'nonce'            => wp_create_nonce( 'cst_homepage_more_headlines_v3' ),
		) );
