...
class CST_Chicago_Wire_Curator {
    ...
    public function action_restrict_manage_posts_refresh_button() {
        ...
        submit_button( esc_attr__( 'Delete Oldest 50 Items', 'chicagosuntimes' ), 'button', false, false, array( 'id' => 'cst-delete-chicago-wire-items', 'data-nonce' => wp_create_nonce( 'cst_delete_chicago_wire_items' ), 'data-in-progress-text' => esc_attr__( 'Deleting...', 'chicagosuntimes' ) ) );
     ...
     * @param \CST\Objects\Chicago_Wire_Item $item
    ...
    public function handle_ajax_refresh_chicago_wire_items() {
        ...
        $this->refresh_chicago_wire_items( true );
     ...
     */
    public function refresh_chicago_wire_items( $manually_triggered_from_ajax = false ) {
