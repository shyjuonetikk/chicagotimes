...
if ( 'wpuser' === $queried_object->type || 'guest-author' === $queried_object->type ) {
	$author_email       = false;
	$author_description = false;
	$author_twitter     = false;
	if ( 'wpuser' === $queried_object->type ) {
		$author              = new \CST\Objects\User( get_queried_object_id() );
	...
	} else if ( 'guest-author' === $queried_object->type ) {
