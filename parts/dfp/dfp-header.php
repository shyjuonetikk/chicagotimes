...
<script type='text/javascript'>
	googletag.cmd.push(function() {
		...
		if ( window.innerWidth > 640 ) {
			...
			CSTAdTags['div-gpt-article-sidebar-cube'] = googletag.defineSlot(<?php echo wp_json_encode('/61924087/chicago.suntimes.com/chicago.suntimes.com.' . $dfp_slug . '/chicago.suntimes.com.' . $dfp_slug . '.index'); ?>, [300, 250], 'div-gpt-article-sidebar-cube')
			.addService(googletag.pubads())
		...
		CSTAdTags['div-gpt-wire-cube-1'] = googletag.defineSlot(<?php echo wp_json_encode('/61924087/chicago.suntimes.com/chicago.suntimes.com.' . $dfp_slug . '/chicago.suntimes.com.' . $dfp_slug . '.index'); ?>, [300, 250], 'div-gpt-wire-cube-1')
		.addService(googletag.pubads())
		.setTargeting("pos","wire cube 1");

		CSTAdTags['div-gpt-wire-cube-2'] = googletag.defineSlot(<?php echo wp_json_encode('/61924087/chicago.suntimes.com/chicago.suntimes.com.' . $dfp_slug . '/chicago.suntimes.com.' . $dfp_slug . '.index'); ?>, [300, 250], 'div-gpt-wire-cube-2')
		.addService(googletag.pubads())
